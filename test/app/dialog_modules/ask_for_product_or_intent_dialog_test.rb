...
class AskForProductOrIntentDialogTest < Minitest::Test
  ...
  def test_init_prompts
    ...
    prompts = AskForProductOrIntentDialog.session_prompts(session)
  ...
  def test_next_dialog
    ...
    expected = nil
    assert_equal expected, AskForProductOrIntentDialog.execute_action(session)
  end
