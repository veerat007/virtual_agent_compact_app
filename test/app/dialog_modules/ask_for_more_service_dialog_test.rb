...
class AskForMoreServiceDialogTest < Minitest::Test
  ...
  def test_init_prompts
    ...
    prompts = AskForMoreServiceDialog.session_prompts(session)
  ...
  def test_next_dialog
    ...
    expected = nil
    assert_equal expected, AskForMoreServiceDialog.execute_action(session)
  end
