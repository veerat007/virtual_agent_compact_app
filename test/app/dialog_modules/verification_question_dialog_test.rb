...
class VerificationQuestionDialogTest < Minitest::Test
  ...
  def test_init_prompts
    ...
    prompts = VerificationQuestionDialog.session_prompts(session)
  ...
  def test_next_dialog
    ...
    expected = nil
    assert_equal expected, VerificationQuestionDialog.execute_action(session)
  end
