...
class AskForProductDialogTest < Minitest::Test
  ...
  def test_init_prompts
    ...
    prompts = AskForProductDialog.session_prompts(session)
  ...
  def test_next_dialog
    ...
    expected = nil
    assert_equal expected, AskForProductDialog.execute_action(session)
  end
