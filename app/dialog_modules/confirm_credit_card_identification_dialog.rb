class ConfirmCreditCardIdentificationDialog < ApplicationBaseDialog
  ...
  init1         AmiVoice::DialogModule::Settings.dialog_property.confirm_credit_card_identification_dialog.prompts.init[0]
  init2         AmiVoice::DialogModule::Settings.dialog_property.confirm_credit_card_identification_dialog.prompts.init[0]
  init3         AmiVoice::DialogModule::Settings.dialog_property.confirm_credit_card_identification_dialog.prompts.init[0]
