...
class CreditCardIdentificationDialogTest < Minitest::Test
  ...
  def test_init_prompts
    ...
    prompts = CreditCardIdentificationDialog.session_prompts(session)
  ...
  def test_next_dialog
    ...
    expected = nil
    assert_equal expected, CreditCardIdentificationDialog.execute_action(session)
  end
