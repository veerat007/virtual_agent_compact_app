...
class ConfirmIntentionDialogTest < Minitest::Test
  ...
  def test_init_prompts
    ...
    prompts = ConfirmIntentionDialog.session_prompts(session)
  ...
  def test_next_dialog
    ...
    expected = nil
    assert_equal expected, ConfirmIntentionDialog.execute_action(session)
  end
