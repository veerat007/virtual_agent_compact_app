...
class ConfirmIntentionToAgentDialogTest < Minitest::Test
  ...
  def test_init_prompts
    ...
    prompts = ConfirmIntentionToAgentDialog.session_prompts(session)
  ...
  def test_next_dialog
    ...
    expected = nil
    assert_equal expected, ConfirmIntentionToAgentDialog.execute_action(session)
  end
